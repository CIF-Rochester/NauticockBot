...
class Admin(commands.Cog):
    ...
    async def botsay(self, interaction: nextcord.Interaction, msg: str, channel_id: str):
        logger.info(
    ...
    async def reactionrole(self, interaction: nextcord.Interaction, msg_id: str, emoji: str, role_id: str):
        logger.info(
        ...
        if role:
            ...
            self.reactionRolesJson = utils.load_json(self.json_filename)
            logger.info(
                f"Reaction roles updated and saved to {self.json_filename}")
        else:
            await interaction.response.send_message(self.NO_PERMS_MSG)
            logger.warning(
    ...
    async def on_raw_reaction_add(self, payload: nextcord.RawReactionActionEvent):
        ...
        try:
            role_id = self.reactionRolesJson[str(
                payload.message_id)][str(emoji_name)]["role"]
    ...
    async def gatekeeper_log(self, interaction: nextcord.Interaction, yesterday: bool = False, day: str = None):
        logger.info(
